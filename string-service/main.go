...
import (
	...
	"flag"
	"fmt"
	"go-micro/string-service/config"
	"go-micro/string-service/endpoint"
	"go-micro/string-service/plugins"
	"go-micro/string-service/service"
	"go-micro/string-service/transport"
	"go-micro/discover"
